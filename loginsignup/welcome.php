...
<body>
  ...
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2"><a href="personal.php">Personal Loan</a></div>
...
<div class="h-64 w-64 rounded overflow-hidden shadow-lg m-6">
  <img class="w-full" src="../img/business.jpg" alt="Sunset in the mountains">
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2"><a href="business.php">Business Loan</a></div>
    <p class="text-gray-700 text-base">
...
<div class="h-64 w-64 rounded overflow-hidden shadow-lg m-6">
  <img class="w-full" src="../img/home.jpg" alt="Sunset in the mountains">
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2"><a href="homeloan.php">Home Loan</a></div>
    <p class="text-gray-700 text-base">
      A home loan is a secured loan that is obtained to purchase a property by offering it.
    </p>
  </div>
</div>

<div class="h-64 w-64 rounded overflow-hidden shadow-lg m-6">
  <img class="w-full" src="../img/car.png" alt="Sunset in the mountains">
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2"><a href="carloan.php">Car Loan</a></div>
    <p class="text-gray-700 text-base">
    Loan amount ranging from BDT 3 lac to BDT 40 lac · Financing up to 50%.
    </p>
  </div>
</div>

<div class="h-64 w-64 rounded overflow-hidden shadow-lg m-6">
  <img class="w-full" src="../img/student.jpg" alt="Sunset in the mountains">
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2"><a href="studentloan.php">Student Loan</a></div>
    <p class="text-gray-700 text-base">
    A student loan is money borrowed from the government lender.
    </p>
  </div>
</div>
        </section>
