...
<section>
    <div class="font-sans">
        <div class="relative min-h-screen flex flex-col sm:justify-center items-center bg-[#14B8A6] ">
            <div class="relative sm:max-w-sm w-full">
                ...
                <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                    ...
                    <form method="post" action="validation.php" class="mt-10">
                                       
                        <div>
                            <input type="email" placeholder="Your Email" class="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                        </div>
                        ...
                        <div class="mt-7 flex">
                            <label for="Remember Me" class="inline-flex items-center w-full cursor-pointer">
                        ...
                        <div class="flex mt-7 justify-center w-full">
                         ...
                         <div class="mt-7">
                            <div class="flex justify-center items-center">
                                ...
                                <a href="signupU.html" class=" text-blue-500 transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                                    Create an Account
                                </a>
                            </div>
                        </div>
